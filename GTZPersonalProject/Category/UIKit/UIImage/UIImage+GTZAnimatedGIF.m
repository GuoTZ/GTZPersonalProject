...
@implementation UIImage (GTZAnimatedGIF)
...
+ (UIImage *)gtz_AnimatedImageWithAnimatedGIFData:(NSData *)data {
    return animatedImageWithAnimatedGIFReleasingImageSource(CGImageSourceCreateWithData(toCF data, NULL));
}

+ (UIImage *)gtz_AnimatedImageWithAnimatedGIFURL:(NSURL *)url {
